...
from lerobot.utils.attention_maps.act_attention_mapper import ACTPolicyWithAttention
...
def prepare_observation_for_policy(frame: dict, 
    ...
    for key, value in frame.items():
        ...
        # (Ad): Support for task instruction input
        elif key in ['task']:
        ...
        with torch.inference_mode():
            if hasattr(policy, 'select_action'):
                ...
                if isinstance(result, tuple):
                    ...
                    # Ad TODO: task attention also return
